...
//            GlobalManager.Current._Agm800.controller0.GetCiGroup(AxisRef.A).LinearAbsoluteXY(50000, -200000, 100000, 20000);
...
//            while (GlobalManager.Current._Agm800.controller0.GetAxis(AxisRef.A).InTargetStat != 4 || GlobalManager.Current._Agm800.controller0.GetAxis(AxisRef.B).InTargetStat != 4)
//            {
//                if (GlobalManager.Current.IsPause)
//                {
//                    GlobalManager.Current._Agm800.controller0.GetCiGroup(AxisRef.A).Pause();
//                    Thread.Sleep(10);
//                }
//                else
//                {
//                    GlobalManager.Current._Agm800.controller0.GetCiGroup(AxisRef.A).Resume();
//                    Thread.Sleep(10);
//                }
...
//            GlobalManager.Current._Agm800.controller0.GetCiGroup(AxisRef.A).ClearBuffer();
//            GlobalManager.Current._Agm800.controller0.GetCiGroup(AxisRef.A).LinearAbsoluteXY(-200000, 50000, 100000, 20000);
//            GlobalManager.Current._Agm800.controller0.GetCiGroup(AxisRef.A).Begin();
