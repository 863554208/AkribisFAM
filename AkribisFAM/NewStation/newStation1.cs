...
{
    internal class newStation1 : WorkStationBase
    {
        ...
        public void AllWorkStopCylinderAct(int extendValue, int retractValue)
        {
            ...
            if ( extendValue == 1)
            {
                WaitIO(999, IO_INFunction_Table.IN3_0Stopping_cylinder_1_extend_InPos, true);
                WaitIO(999, IO_INFunction_Table.IN3_2Stopping_cylinder_2_extend_InPos, true);
                WaitIO(999, IO_INFunction_Table.IN3_4Stopping_cylinder_3_extend_InPos, true);
            }
            if(retractValue == 1)
            {
                WaitIO(999, IO_INFunction_Table.IN3_1Stopping_cylinder_1_react_InPos, true);
                WaitIO(999, IO_INFunction_Table.IN3_3Stopping_cylinder_2_react_InPos, true);
                WaitIO(999, IO_INFunction_Table.IN3_5Stopping_cylinder_3_react_InPos, true);
            }
        ...
        public override void AutoRun()
        {
            ...
            STEP_WaitTrayThroughStopCylinder:
                ...
                while ( IN1_10 == true && IN1_11 == true && IN6_6 == true )   //电路逻辑接反了  ,任一光电被触发后，就退出循环
                { 
                ...
                while (IN1_10 == false || IN1_11 == false || IN6_6 == false)     //电路逻辑接反了   ，所有料盘流出此光电后，退出循环
                {
                    System.Threading.Thread.Sleep(10);
            ...
            STEP_WaitStopCylinderExtend:
                ...
                while ( IN1_0 == false && IN1_1 == false  && IN1_2 == false )
                {
                    System.Threading.Thread.Sleep(10);
                }
            STEP_BeltSlowDown:
