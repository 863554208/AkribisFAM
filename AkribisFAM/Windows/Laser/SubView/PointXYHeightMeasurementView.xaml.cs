...
{
    /// <summary>
    /// Interaction logic for PointXYHeightMeasurementView.xaml
    /// </summary>
    public partial class PointXYHeightMeasurementView : UserControl
    {
        public PointXYHeightMeasurementView()
        {
            InitializeComponent();
        }
